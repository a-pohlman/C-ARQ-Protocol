...
The original research was started by **Cooper J. Koch** and **Alexander H. Burkholder** under the research advisor [**Ahmed Ammar**](https://www.onu.edu/directory/ahmed-ammar) at [<ins>Ohio Northern University</ins>](https://www.onu.edu/). The research for C-ARQ is now being continued by **Aaron J. Pohlman** under the research advisor [**Ahmed Ammar**](https://www.onu.edu/directory/ahmed-ammar) at [<ins>Ohio Northern University</ins>](https://www.onu.edu/) to further invstigate network trends and simulating trojan attacks. 
